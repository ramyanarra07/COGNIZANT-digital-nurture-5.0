...
<!-- Drag & drop your HANDSON1-4 screenshots here — Task 1 (CREATE TABLE / SHOW TABLES / DESCRIBE students) and Task 3 (ALTER TABLE, column rename, INFORMATION_SCHEMA verification) -->
...
<!-- Drag & drop your HANDSON1-4 screenshots here — Task 1 (INSERT/UPDATE/DELETE + row counts), Task 2 (single-table filters), Task 3 (multi-table JOINs), Task 4 (aggregations & grouping) -->
...
<!-- Drag & drop your HANDSON1-4 screenshots here — Task 1 (subqueries: above-average enrollments, top-paid professor, departments), Task 2 (view creation & querying), Task 3 (SAVEPOINT / ROLLBACK TO SAVEPOINT / COMMIT) -->
...
<!-- Drag & drop your HANDSON1-4 screenshots here — Task 1 (baseline EXPLAIN showing full table scan), Task 2 (indexes created + EXPLAIN FORMAT=JSON after) -->
...
<!-- Drag & drop your HANDSON5 screenshots here — collection creation & inserts, CRUD queries, aggregation pipeline output -->
...
<!-- Drag & drop your HANDSON6 screenshots here — models.py table creation, CRUD via session, echo=True query logs before/after joinedload -->
...
<!-- Drag & drop your HANDSON7 screenshots here — alembic init/upgrade head, revision history, downgrade/upgrade verification -->
